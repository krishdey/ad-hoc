...
public class RowKeyRenameImporter {
	...
	public static class NodeKeyRenameImport extends TableMapper<ImmutableBytesWritable, Mutation> {
		...
		private static final byte[] FAMILY = Bytes.toBytes("node");
		private static final byte[] QUALIFIER = Bytes.toBytes("hashedIdentifier");
		...
		protected void processKV(ImmutableBytesWritable key, Result result, Context context, Put put)
			...
			for (Cell kv : result.rawCells()) {
				...
				put.addColumn(FAMILY, QUALIFIER, renameRowKey.get());
	...
	public static class NodeLinkRenameImport extends TableMapper<ImmutableBytesWritable, Mutation> {
		...
		private Durability durability;
		private RowKeyRename rowkeyRenameAlgo;
		private static final byte[] FAMILY = Bytes.toBytes("nodelink");
		...
		protected void processKV(ImmutableBytesWritable key, Result result, Context context, Put put)
			...
			ImmutableBytesWritable leftNodeId = new ImmutableBytesWritable(
					CellUtil.cloneValue(result.getColumnLatestCell(FAMILY, Q_LEFT_NODE_ID)));
			ImmutableBytesWritable linkTypeId = new ImmutableBytesWritable(
					CellUtil.cloneValue(result.getColumnLatestCell(FAMILY, Q_LINK_TYPE_ID)));
			ImmutableBytesWritable rightNodeId = new ImmutableBytesWritable(
					CellUtil.cloneValue(result.getColumnLatestCell(FAMILY, Q_RIGHT_NODE_ID)));
